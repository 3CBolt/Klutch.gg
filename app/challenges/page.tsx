...
function ChallengeList({
  ...
  challenges: Awaited<ReturnType<typeof getAllChallenges>>;
}) {
        ...
        <tbody className="divide-y divide-gray-200 bg-white">
          {challenges.map((challenge) => (
            <tr key={challenge.id} className="hover:bg-gray-50">
              ...
              <td className="hidden sm:table-cell whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                {challenge.winner
                  ? challenge.winner.name || challenge.winner.email || "Unknown"
                  : "-"}
              </td>
          ...
          <div className="sm:flex sm:items-center">
            <div className="sm:flex-auto">
              ...
              <p className="mt-2 text-sm text-gray-700">
                Browse open challenges or create your own. Completed and
                disputed challenges can be found in Challenge History.
              </p>
            </div>
