          ...
          <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <dd className="mt-1 text-3xl font-semibold text-gray-900">{stats.kdRatio.toFixed(2)}</dd>
              </div>
            </div>
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <dt className="text-sm font-medium text-gray-500 truncate">Win Rate</dt>
                <dd className="mt-1 text-3xl font-semibold text-gray-900">{stats.winRate.toFixed(1)}%</dd>
              </div>
            </div>
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <dt className="text-sm font-medium text-gray-500 truncate">Total Games</dt>
                <dd className="mt-1 text-3xl font-semibold text-gray-900">{stats.gamesPlayed}</dd>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-4">
                  <div className="rounded-md bg-gray-50 p-4">
                    ...
                    <p className="mt-1 text-lg font-semibold text-gray-900">{stats.kills}</p>
                  </div>
                  <div className="rounded-md bg-gray-50 p-4">
                    <p className="text-sm font-medium text-gray-500">Deaths</p>
                    <p className="mt-1 text-lg font-semibold text-gray-900">{stats.deaths}</p>
                  </div>
                  <div className="rounded-md bg-gray-50 p-4">
                    <p className="text-sm font-medium text-gray-500">Wins</p>
                    <p className="mt-1 text-lg font-semibold text-gray-900">{stats.wins}</p>
                  </div>
                  <div className="rounded-md bg-gray-50 p-4">
                    <p className="text-sm font-medium text-gray-500">Losses</p>
                    <p className="mt-1 text-lg font-semibold text-gray-900">{stats.gamesPlayed - stats.wins}</p>
                  </div>
                </div>
              </div>
            </div>
