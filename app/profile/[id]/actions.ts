    ...
    await prisma.user.update({
      ...
      data: {
        ...
        gamingStats: {
          ...
          kdRatio: validatedData.deaths === 0 ? validatedData.kills : Number((validatedData.kills / validatedData.deaths).toFixed(2)),
          winRate: validatedData.gamesPlayed === 0 ? 0 : Number(((validatedData.wins / validatedData.gamesPlayed) * 100).toFixed(1))
        },
      },
    });
